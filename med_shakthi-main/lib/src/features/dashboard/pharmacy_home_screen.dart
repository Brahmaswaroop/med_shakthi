...
import 'package:med_shakthi/src/features/wishlist/data/wishlist_singleton.dart';
...
class _PharmacyHomeScreenState extends State<PharmacyHomeScreen> {
      ...
      onTap: () {
        if (label == "Medicines") {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => const CategoryPageNew(),
            ),
          );
        }
      },
  ...
  Widget _buildProductCard(Product product) {
    return _ProductCardWithWishlist(
      product: product,
...
/// Product Card with Wishlist Icon
class _ProductCardWithWishlist extends StatefulWidget {
  final Product product;
  final WishlistService wishlistService;

  const _ProductCardWithWishlist({
    required this.product,
    required this.wishlistService,
  });

  @override
  State<_ProductCardWithWishlist> createState() => _ProductCardWithWishlistState();
}

class _ProductCardWithWishlistState extends State<_ProductCardWithWishlist> {
  @override
  Widget build(BuildContext context) {
    final bool isWishlisted = widget.wishlistService.isInWishlist(widget.product.id);
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: InkWell(
                      onTap: () async {
                        if (isWishlisted) {
                          await widget.wishlistService.removeFromWishlist(widget.product.id);
                        } else {
                          await widget.wishlistService.addToWishlist(
                            WishlistItem(
